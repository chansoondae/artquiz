    ...
    <div className="mt-8 p-5 bg-purple-50 rounded-lg border border-purple-100">
      ...
      <div className="flex flex-wrap justify-center gap-3">
        ...
        <button 
          ...
          className="flex items-center space-x-2 px-4 py-2 bg-blue-600 text-white rounded-full shadow-sm hover:bg-blue-700 transition-colors"
        ...
        <button 
          ...
          className="flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500 text-white rounded-full shadow-sm hover:opacity-90 transition-opacity"
        ...
        <button 
          ...
          className="flex items-center space-x-2 px-4 py-2 bg-green-600 text-white rounded-full shadow-sm hover:bg-green-700 transition-colors"
        ...
        <div className="mt-3">
            <button 
            className="flex items-center space-x-2 px-4 py-2 bg-yellow-400 text-black rounded-full shadow-sm hover:bg-yellow-500 transition-colors mx-auto"
            aria-label="카카오톡으로 공유"
            >
            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path d="M12 3C7.0374 3 3 6.21591 3 10.1934C3 12.7693 4.7162 15.0241 7.27959 16.2204C7.03358 17.1391 6.60747 18.7461 6.44467 19.2561C6.23512 19.9388 6.67073 19.917 7.21634 19.5387C7.6392 19.2323 9.35168 18.0961 10.3382 17.4127C11.0373 17.5223 11.5158 17.5897 12 17.5897C16.9626 17.5897 21 14.3733 21 10.1934C21 6.21591 16.9626 3 12 3Z" />
            </svg>
            <span>카카오톡</span>
            </button>
        </div>
        ...
        <button 
          ...
          className="flex items-center space-x-2 px-4 py-2 bg-gray-600 text-white rounded-full shadow-sm hover:bg-gray-700 transition-colors"
          aria-label="URL 복사"
        >
