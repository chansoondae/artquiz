...
export default function ImageProGenerator() {
  ...
  const processImageGeneration = async (data, userNickname) => {
    ...
    try {
      ...
      formData.append('styleId', "free");
        formData.append('styleName', "free");
  ...
  return (
    <div className="min-h-screen py-2 px-4 max-w-5xl mx-auto">
      <header className="mb-12 text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-2 text-fuchsia-900">이미지 프로</h1>
        <p className="text-lg text-gray-700">자유롭게 프롬프트를 입력하여 AI로 이미지를 변환해보세요!</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">
                예시: "이 이미지를 반 고흐 스타일로 변환해주세요", "이 풍경에 오로라를 추가해주세요"
              </p>
            </div>
        ...
        <div className="art-card bg-white bg-opacity-70 backdrop-blur-sm p-6 rounded-xl shadow-md border border-fuchsia-100">
          {generatedImage || (originalImage && loading) ? (
            ...
            <div className="h-full flex flex-col items-center justify-center text-center p-6">
              ...
              <h3 className="text-lg font-medium text-fuchsia-900 mb-2">이미지를 업로드하고 프롬프트를 입력해주세요</h3>
              <p className="text-gray-600">
                자유롭게 AI에게 지시하여 이미지를 원하는대로 변환해보세요.
              </p>
            </div>
          )}
        </div>
